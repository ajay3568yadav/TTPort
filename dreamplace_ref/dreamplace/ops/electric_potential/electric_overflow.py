...
try:
    ...
    raise ImportError(
        "electric_potential_cpp compiled extension not found. "
        "Run TTPort/setup.sh to copy compiled extensions from the DREAMPlace build."
    ) from _cpp_err
...
if configure.compile_configurations["CUDA_FOUND"] == "TRUE":
    try:
        ...
        electric_potential_cuda = None  # type: ignore[assignment]
